export const microsoft = {
  ...
  "industryExposures": {
    "ai-server": {
      "score": 66,
      "label": "AI Server",
      "thesis": "Microsoft 在 AI Server 的曝險主要來自 Cloud 角色、客戶拉貨與供應鏈瓶頸傳導。",
      "drivers": [
    ...
    "power-cooling": {
      "score": 58,
      "label": "Power & Cooling",
      "thesis": "Microsoft 在 Power & Cooling 的曝險主要來自 Cloud 角色、客戶拉貨與供應鏈瓶頸傳導。",
      "drivers": [
        "屬於關聯供應鏈節點，主要受到客戶資本支出與技術節點切換影響。",
        "需同時追蹤 SEC filings、產品發布與雲端資本支出。"
      ],
    ...
    "optical": {
      ...
      "thesis": "Microsoft 在 Optical Communication 的曝險主要來自 Cloud 角色、客戶拉貨與供應鏈瓶頸傳導。",
      "drivers": [
        "屬於關聯供應鏈節點，主要受到客戶資本支出與技術節點切換影響。",
        "需同時追蹤 SEC filings、產品發布與雲端資本支出。"
      ],
    ...
    "memory": {
      "score": 24,
      "label": "Memory",
      "thesis": "Microsoft 在 Memory 的曝險主要來自 Cloud 角色、客戶拉貨與供應鏈瓶頸傳導。",
      "drivers": [
        "屬於關聯供應鏈節點，主要受到客戶資本支出與技術節點切換影響。",
        "需同時追蹤 SEC filings、產品發布與雲端資本支出。"
      ],
  ...
  "swot": {
    "strengths": [
      {
        "label": "Role clarity",
        "detail": "Microsoft 在 AI Server 供應鏈中角色明確，可從 Cloud 追蹤需求傳導。",
        "sourceKeys": [
          "secEdgar",
          "nasdaqDataLink",
          "occMarketData",
